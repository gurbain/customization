...
export DEFAULT_USER="gabs48"								# Username to consider a "default context" (you can also
															# set $USER).
...
POWERLEVEL9K_ALWAYS_SHOW_USER=true							# Always show the username, but conditionalize the
															# hostname.
POWERLEVEL9K_CONTEXT_TEMPLATE="\uf2c0 %n"						# Default context prompt (username@machine).
...
POWERLEVEL9K_IP_INTERFACE="eth0"							# The NIC for which you wish to display the IP address.
															# Example: eth0.
...
POWERLEVEL9K_TIME_FORMAT="%D{%H:%M:%S \uf073 }"	# Output time, date, and a symbol  from the "Awesome
															# Powerline Font" set
...
POWERLEVEL9K_CONTEXT_VISUAL_IDENTIFIER_COLOR="black"
...
POWERLEVEL9K_USER_VISUAL_IDENTIFIER_COLOR="black"

# *****  host  *****
POWERLEVEL9K_HOST_BACKGROUND="blue"
POWERLEVEL9K_HOST_FOREGROUND="white"
POWERLEVEL9K_HOST_VISUAL_IDENTIFIER_COLOR="black"

# *****  date  *****
POWERLEVEL9K_DATE_BACKGROUND="black"
POWERLEVEL9K_DATE_FOREGROUND="blue"
...
if [[ "${TERM}" =~ "tmux" || "${TERM}" =~ "screen" ]]; then
	# Segment list for left prompt
	POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir_writable dir background_jobs command_execution_time)
	# Segment list for right prompt
